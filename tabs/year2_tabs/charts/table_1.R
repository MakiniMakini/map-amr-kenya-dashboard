...
tab_table_1 <- tabItem(tabName = "tab_table_1",
                                        box(
                                          title = tagList(
                                            id = "tabs_prospective",
                                            "Recent surgeries",
                                            selectInput("prospective_select", "Select Prospective Category", choices = c("Categories ..", "Table 1", "TNH", "NSIRH", "JOOTRH"), selected = "")
                                          ),
                                          solidHeader = TRUE,
                                          status = "gray-dark",
                                          collapsible = TRUE,
